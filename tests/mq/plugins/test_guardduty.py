...
class TestGuardDuty(object):
                        ...
                        'networkInterfaces': [
                            {
                                ...
                                'vpcId': 'vpc-7ba6241f',
                                'securityGroups': [{'groupName': 'launch-wizard-2', 'groupId': 'sg-2187695b'}],
                ...
                'finding': {
                    ...
                    'action': {
                        ...
                        'portProbeAction': {
                            'portProbeDetails': [
                                {
                                    'localPortDetails': {'port': 443, 'portName': 'HTTPS'},
                                    'remoteIpDetails': {
                                        ...
                                        'geoLocation': {'lat': 37.1825, 'lon': 126.8783},
                                    },
                                },
                                {
                                    'localPortDetails': {'port': 8443, 'portName': 'Unknown'},
                                    'remoteIpDetails': {
                                        'ipAddressV4': '211.44.226.158',
                                        'organization': {
                                            'asn': '9318',
                                ...
                                },
                                {
                                    ...
                                    'remoteIpDetails': {
                                        ...
                                        'country': {'countryName': 'South Korea'},
                                        'city': {'cityName': ''},
                                        'geoLocation': {'lat': 37.5112, 'lon': 126.9741},
                                    },
                                },
                                {
                                ...
                                {
                                    'localPortDetails': {'port': 80, 'portName': 'HTTP'},
                                    'remoteIpDetails': {
                                        'ipAddressV4': '211.44.226.158',
                                        'organization': {
                                            'asn': '9318',
    ...
    def test_torinbound(self):
        event = {'receivedtimestamp': '2019-10-25T00:26:17.948332+00:00', 
                'mozdefhostname': 'mozdefqa2.private.mdc1.mozilla.com', 
                'tags': ['gd2md-GuardDutyEventNormalization-5HTB8BEL5Y1Q-SqsOutput-1D5MQWALTYJ8P'], 
                'severity': 'INFO', 
                'source': 'guardduty', 
                'details': {'schemaVersion': '2.0', 
                    'accountId': '371522382791',
                    'region': 'us-west-2',
                    'partition': 'aws',
                    'id': 'eeb6396cc2ac43cef0d3e77204f202ce',
                    'arn': 'arn:aws:guardduty:us-west-2:371522382791:detector/7ab01139c0b81403b3c8ec8e08cf939c/finding/eeb6396cc2ac43cef0d3e77204f202ce',
                    ...
                    'resource': {'resourceType': 'Instance',
                        'instanceDetails': {'instanceId': 'i-99999999',
                            ...
                            'platform': None,
                            'productCodes': [{'productCodeId':'GeneratedFindingProductCodeId', 'productCodeType':'GeneratedFindingProductCodeType'}], 
                            'iamInstanceProfile': {'arn': 'GeneratedFindingInstanceProfileArn',
                                'id': 'GeneratedFindingInstanceProfileId'},
                            'networkInterfaces': [{'networkInterfaceId':'eni-bfcffe88', 
                                ...
                                'securityGroups':[{'groupName':'GeneratedFindingSecurityGroupName', 'groupId':'GeneratedFindingSecurityId'}], 
                                'publicIp':'198.51.100.0', 
                                'ipv6Addresses':[], 
                                'publicDnsName':'GeneratedFindingPublicDNSName', 
                                'privateIpAddress':'10.0.0.1'}], 
                            'tags': [{'value':'GeneratedFindingInstaceValue1', 'key':'GeneratedFindingInstaceTag1'},
                        ...
                        'severity': 5,
                        'createdAt': '2019-08-08T20:09:13.816Z', 
                        'updatedAt': '2019-10-25T00:24:41.104Z', 
                ...
                'finding': {'serviceName': 'guardduty', 
                        ...
                        'action': {'actionType': 'NETWORK_CONNECTION',
                            'networkConnectionAction': {'connectionDirection': 'INBOUND',
                                ...
                                'remotePortDetails': {'port': 39677, 'portName': 'Unknown'},
                                'localPortDetails': {'port': 80, 'portName': 'HTTP'},
                                'protocol': 'TCP', 'blocked': False}}, 
                            'resourceRole': 'TARGET',
                            'additionalInfo': {'sample': True}, 
                            'evidence': {'threatIntelligenceDetails': [{'threatNames':['GeneratedFindingThreatName'], 
                                'threatListName':'GeneratedFindingThreatListName'}]}, 
                            'eventFirstSeen': '2019-08-08T20:09:13.816Z',
                            'eventLastSeen': '2019-10-25T00:24:41.104Z',
                            'archived': False, 'count': 21},
                'category': 'UnauthorizedAccess:EC2/TorIPCaller', 
                'tags': ['NETWORK_CONNECTION']}, 
                'hostname': 'i-99999999',
                'summary': 'IP address 198.51.100.0 on the Tor Anonymizing Proxy network is communicating with EC2 instance i-99999999.', 
                'utctimestamp': '2019-10-25T00:26:17.227000+00:00',
                'timestamp': '2019-10-25T00:26:17.227000+00:00'}
    ...
    def test_toroutbound(self):
        event = {'receivedtimestamp': '2019-10-25T00:26:19.073561+00:00',
                'mozdefhostname': 'mozdefqa2.private.mdc1.mozilla.com',
                'tags': ['gd2md-GuardDutyEventNormalization-5HTB8BEL5Y1Q-SqsOutput-1D5MQWALTYJ8P'],
                'severity': 'INFO',
                'source': 'guardduty',
                'details': {'schemaVersion': '2.0',
                    ...
                    'instanceDetails': {'instanceId': 'i-99999999',
                        ...
                        'launchTime': '2016-08-02T02:05:06Z',
                        'platform': "None",
                        'productCodes': [{'productCodeId': 'GeneratedFindingProductCodeId',
                        ...
                        'networkInterfaces': [{'networkInterfaceId': 'eni-bfcffe88',
                            ...
                            'vpcId': 'GeneratedFindingVPCId',
                            'privateDnsName': 'GeneratedFindingPrivateDnsName',
                            'securityGroups': [{'groupName': 'GeneratedFindingSecurityGroupName',
                                'groupId': 'GeneratedFindingSecurityId'}],
                            'publicIp': '198.51.100.0',
                            'ipv6Addresses': [],
                            'publicDnsName': 'GeneratedFindingPublicDNSName',
                            'privateIpAddress': '10.0.0.1'}],
                        'tags': [{'value': 'GeneratedFindingInstaceValue1',
    ...
    def test_ddossourcetcp(self):
        event = {   'details': {   'accountId': '371522382791',
                   ...
                   'finding': {   'action': {   'actionType': 'NETWORK_CONNECTION',
                                                'networkConnectionAction': {   'blocked': False,
                                                                               'connectionDirection': 'OUTBOUND',
                                                                               'localPortDetails': {   'port': 24198,
                                                                                                       'portName': 'Unknown'},
                                                                               'protocol': 'TCP',
                   ...
                   'partition': 'aws',
                   'region': 'us-west-2',
                   'resource': {   'instanceDetails': {   'availabilityZone': 'GeneratedFindingInstaceAvailabilityZone',
                                                          'iamInstanceProfile': {   'arn': 'GeneratedFindingInstanceProfileArn',
                                                                                    'id': 'GeneratedFindingInstanceProfileId'},
                                                          'imageDescription': 'GeneratedFindingInstaceImageDescription',
                                                          'imageId': 'ami-99999999',
    ...
    def test_ddossourceudp(self):
        event = {   'details': {   'accountId': '371522382791',
                   ...
                   'description': 'EC2 instance i-99999999 is behaving in a manner that may indicate it is being used to perform a Denial o  f Service (DoS) attack using UDP protocol.',
                   'finding': {   'action': {   'actionType': 'NETWORK_CONNECTION',
                                                'networkConnectionAction': {   'blo  cked': False,
                                                                               'connectionDirection': 'OU  TBOUND',
                                                                               'localPortDetails': {   'port': 24198,
                                                                                                       'portName': 'Unknown'},
                                                                               'protocol': 'UDP',
                                                                               'remoteIpDetails': {   'city': {   'cityName': 'GeneratedFindingCityName'},
                                                                                                      'country': {   'countryName': 'GeneratedFindingCount  ryName'},
                                                                                                      'geoLocation': {   'lat': 0,
                                                                                                                         'lon': 0},
                                                                                                      'ipAddressV4': '198.51.100.0',
                                                                                                      'organization': {   'asn': '-1',
                   ...
                   'partition': 'aws',
                   'region': 'us-west-2',
                   'resource': {   'instanceDetails': {   'availabilityZone': 'GeneratedFindingInstaceAvailabilityZon  e',
                                                          'iamInstanceProfile': {   'arn': 'GeneratedFindingInstanceProfileArn',
                                                                                    'id': 'GeneratedFindingInstanceProfileId'},
                                                          'imageDescription': 'GeneratedFindingInstaceImageDescription',
                                                          'imageId': 'ami-99999999',
    ...
    def test_trojandgadomainrequestb(self):
        event = {   'details': {   'accountId': '371522382791',
                   ...
                   'finding': {   'action': {   'actionType': 'DNS_REQUEST',
                                                'dnsRequestAction': {   'blocked': "True",
                                                                        'domain': 'GeneratedFindingDomainName',
                                                                        'protocol': '0'}},
                                  'additionalInfo': {   'domain': 'GeneratedFindingAdditionalDomainName',
                                                        'sample': "True"},
                                  'archived': "False",
                                  'count': 21,
                                  'detectorId': '7ab01139c0b81403b3c8ec8e08cf939c',
    ...
    def test_apifromtor(self):
        ...
        event = {   'category': 'UnauthorizedAccess:IAMUser/TorIPCaller',
    'details': {   'accountId': '371522382791',
                   ...
                   'finding': {   'action': {   'actionType': 'AWS_API_CALL',
                                  ...
                                  'additionalInfo': {   'apiCalls': [   {   'count': 2,
