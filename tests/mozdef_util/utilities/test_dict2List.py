...
TEST_ALERT = {
    ...
    "severity": "WARNING",
    "summary": "hsoto@mozilla.com seen in Anaheim,US then San Diego,US (124.23 KM in 0.01 minutes); San Diego,US then Anaheim,US (124.23 KM in 4.41 minutes); Anaheim,US then San Diego,US (124.23 KM in 0.01 minutes); Anaheim,US then San Diego,US (124.23 KM in 0.01 minutes)",
    "category": "geomodel",
    "tags": ["geomodel"],
    "events": [
        {
            ...
            "documentsource": {
                ...
                "details": {
                    ...
                    "result": "success",
                    "sourceipaddress": "172.58.31.170",
                    "success": True,
                    "txid": "ce2e7158-f1a3-4b34-8488-3ccaf39ca30d",
                    "userkey": "DU3WROU2UXE8NA7138EL",
                    "username": "hsoto@mozilla.com",
                    "sourceipv4address": "172.58.31.170",
                    "sourceipgeolocation": {
                        "city": "Anaheim",
                        "continent": "NA",
                        "country_code": "US",
                ...
                "hostname": "mozdef4.private.mdc1.mozilla.com",
                "processid": "10391",
                "processname": "/opt/mozdef/envs/mozdef/cron/duo_logpull.py",
                "severity": "INFO",
                "summary": "authentication success for hsoto@mozilla.com",
                "tags": ["duosecurity"],
        ...
        },
        {
            ...
            "documentsource": {
                ...
                "details": {
                    ...
                    "clientname": "mozilla.zoom.us",
                    "connection": "Mozilla-LDAP",
                    "description": "None",
                    "eventname": "Success Login",
                    "messageid": "5ea05d38d28ace0714820128",
                    "raw": "{'_id': '5ea05d38d28ace0714820128', 'date': '2020-04-22T15:05:28.374Z', 'type': 's', 'description': 'None', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'client_id': 'TnqNECyCfoQYd1X7c4xwMF4PMsEfyWPj', 'client_name': 'mozilla.zoom.us', 'ip': '172.58.31.170', 'client_ip': 'None', 'user_agent': 'Firefox Mobile 75.0.0 / Android 0.0.0', 'details': {'prompts': [{'name': 'lock-password-authenticate', 'initiatedAt': '1587567915617', 'completedAt': '1587567915964', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'strategy': 'ad', 'identity': 'Mozilla-LDAP|hsoto', 'stats': {'loginsCount': '2314'}, 'session_user': '5ea05d2b5441aa04697bbe2e', 'elapsedTime': '347'}, {'name': 'login', 'flow': 'login', 'initiatedAt': '1587567905584', 'completedAt': '1587567915965', 'timers': {'rules': '386'}, 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'elapsedTime': '10381'}, {'name': 'mfa', 'flow': 'mfa', 'initiatedAt': '1587567916358', 'completedAt': '1587567928352', 'performed_acr': ['http://schemas.openid.net/pape/policies/2007/06/multi-factor'], 'performed_amr': ['mfa'], 'provider': 'duo', 'elapsedTime': '11994'}], 'initiatedAt': '1587567905582', 'completedAt': '1587567928372', 'elapsedTime': '22790', 'session_id': 'xUneHabcm83WvtggcG-csaKqfjUCY9Uw', 'device_id': 'v0:88c38ae0-343c-11ea-888a-8fb9710d9719', 'stats': {'loginsCount': '2314'}}, 'hostname': 'auth.mozilla.auth0.com', 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'strategy': 'ad', 'strategy_type': 'enterprise', 'isMobile': 'True'}",
                    "sourceipaddress": "172.58.31.170",
                    "success": True,
                    "useragent": "Firefox Mobile 75.0.0 / Android 0.0.0",
                    "userid": "ad|Mozilla-LDAP|hsoto",
                    "username": "hsoto@mozilla.com",
                    "sourceipv4address": "172.58.31.170",
                    "sourceipgeolocation": {
                        "city": "Anaheim",
                ...
                "severity": "INFO",
                "summary": "Success Login hsoto@mozilla.com",
                "tags": ["auth0"],
        ...
        },
        {
            ...
            "documentsource": {
                ...
                "details": {
                    ...
                    "clientname": "mana.mozilla.org - new",
                    "connection": "Mozilla-LDAP",
                    "description": "None",
                    "eventname": "Success Login",
                    "messageid": "5ea05d825ae00a0d5de5d174",
                    "raw": "{'_id': '5ea05d825ae00a0d5de5d174', 'date': '2020-04-22T15:06:42.179Z', 'type': 's', 'description': 'None', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'client_id': 'Qzs1IbNmnXB1js1KlhhdnwYZT9rwwF4U', 'client_name': 'mana.mozilla.org - new', 'ip': '172.58.31.170', 'client_ip': 'None', 'user_agent': 'Firefox Mobile 75.0.0 / Android 0.0.0', 'details': {'prompts': [{'name': 'authenticate', 'initiatedAt': '1587568001564', 'completedAt': '1587568001742', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'strategy': 'ad', 'identity': 'Mozilla-LDAP|hsoto', 'stats': {'loginsCount': '2315'}, 'elapsedTime': '178'}, {'name': 'login', 'flow': 'login', 'initiatedAt': '1587567997696', 'completedAt': '1587568001746', 'timers': {'rules': '419'}, 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'elapsedTime': '4050'}], 'initiatedAt': '1587567997694', 'completedAt': '1587568002178', 'elapsedTime': '4484', 'session_id': 'xUneHabcm83WvtggcG-csaKqfjUCY9Uw', 'device_id': 'v0:88c38ae0-343c-11ea-888a-8fb9710d9719', 'stats': {'loginsCount': '2315'}}, 'hostname': 'auth.mozilla.auth0.com', 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'strategy': 'ad', 'strategy_type': 'enterprise', 'isMobile': 'True'}",
                    "sourceipaddress": "172.58.31.170",
                    "success": True,
                    "useragent": "Firefox Mobile 75.0.0 / Android 0.0.0",
                    "userid": "ad|Mozilla-LDAP|hsoto",
        ...
        },
        {
            ...
            "documentsource": {
                ...
                "details": {
                    ...
                    "clientname": "Google (mozilla.com)",
                    "connection": "Mozilla-LDAP",
                    "description": "None",
                    "eventname": "Success Login",
                    "messageid": "5ea068294ecfef0d5ede734f",
                    "raw": "{'_id': '5ea068294ecfef0d5ede734f', 'date': '2020-04-22T15:52:09.136Z', 'type': 's', 'description': 'None', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'client_id': 'smKTjsVVxUJDEkjIftOsP0bop2NWjysa', 'client_name': 'Google (mozilla.com)', 'ip': '76.167.185.136', 'client_ip': 'None', 'user_agent': 'Firefox 75.0.0 / Mac OS X 10.14.0', 'details': {'prompts': [{'name': 'authenticate', 'initiatedAt': '1587570728596', 'completedAt': '1587570728676', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'strategy': 'ad', 'identity': 'Mozilla-LDAP|hsoto', 'stats': {'loginsCount': '2317'}, 'elapsedTime': '80'}, {'name': 'login', 'flow': 'login', 'initiatedAt': '1587570728072', 'completedAt': '1587570728680', 'timers': {'rules': '444'}, 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'elapsedTime': '608'}], 'initiatedAt': '1587570728071', 'completedAt': '1587570729135', 'elapsedTime': '1064', 'session_id': 'iHzeCh-tAqtAj_onA-Xm1jO-w45jsng8', 'device_id': 'v0:01b67bb0-17b4-11ea-8202-9fb43e6ec9e0', 'stats': {'loginsCount': '2317'}}, 'hostname': 'auth.mozilla.auth0.com', 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'strategy': 'ad', 'strategy_type': 'enterprise', 'isMobile': 'False'}",
                    "sourceipaddress": "76.167.185.136",
                    "success": True,
                    "useragent": "Firefox 75.0.0 / Mac OS X 10.14.0",
                    "userid": "ad|Mozilla-LDAP|hsoto",
                    "username": "hsoto@mozilla.com",
                    "sourceipv4address": "76.167.185.136",
                    "sourceipgeolocation": {
                        "city": "San Diego",
                        "continent": "NA",
                        "country_code": "US",
        ...
        },
        {
            ...
            "documentsource": {
                ...
                "details": {
                    ...
                    "raw": "{'_id': '5ea068a9f995810715819b3e', 'date': '2020-04-22T15:54:17.352Z', 'type': 's', 'description': 'None', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'client_id': 'smKTjsVVxUJDEkjIftOsP0bop2NWjysa', 'client_name': 'Google (mozilla.com)', 'ip': '76.167.185.136', 'client_ip': 'None', 'user_agent': 'Firefox 75.0.0 / Mac OS X 10.14.0', 'details': {'prompts': [{'name': 'authenticate', 'initiatedAt': '1587570856858', 'completedAt': '1587570856931', 'connection': 'Mozilla-LDAP', 'connection_id': 'con_dc6SPKopkKT33i70', 'strategy': 'ad', 'identity': 'Mozilla-LDAP|hsoto', 'stats': {'loginsCount': '2318'}, 'elapsedTime': '73'}, {'name': 'login', 'flow': 'login', 'initiatedAt': '1587570856299', 'completedAt': '1587570856933', 'timers': {'rules': '407'}, 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'elapsedTime': '634'}], 'initiatedAt': '1587570856298', 'completedAt': '1587570857351', 'elapsedTime': '1053', 'session_id': 'iHzeCh-tAqtAj_onA-Xm1jO-w45jsng8', 'device_id': 'v0:01b67bb0-17b4-11ea-8202-9fb43e6ec9e0', 'stats': {'loginsCount': '2318'}}, 'hostname': 'auth.mozilla.auth0.com', 'user_id': 'ad|Mozilla-LDAP|hsoto', 'user_name': 'hsoto@mozilla.com', 'strategy': 'ad', 'strategy_type': 'enterprise', 'isMobile': 'False'}",
                    "sourceipaddress": "76.167.185.136",
                    "success": True,
                    "useragent": "Firefox 75.0.0 / Mac OS X 10.14.0",
                    "userid": "ad|Mozilla-LDAP|hsoto",
